...
GameTimer = require("common.GameTimer").new()
------------------------------------------------------------------------------
...
function MapRuntime:ctor(map)
    ...
    -- local eventHandlerModuleName = string.format("app.controllers.%sEvents", getId())
    local eventHandlerModule = require("app.controllers.MapEventHandler")
