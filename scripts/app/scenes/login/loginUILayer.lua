...
--
local serverListFile =  G_FLIE_PATH..SERVERFILENAME
local serverlisturl = WEBSERVER_URL..SERVERFILENAME
------------------------------------------------------------------------------
...
------------------------------------------------------------------------------
local M  = class("loginUILayer",require("app.ac.ui.UIManager"))
------------------------------------------------------------------------------
...
function M:connetToLoginServer( _host, _port )
    local CMD = {
        ...
        onEnterSucc = function(subid)
            ...
            NETWORK:encode_send("C2S_Login", msg)
        end,
    }
